...
if "__main__" == __name__:
    ...
    f0_stds = []
    f0_means = []
    for filename in tqdm(list_gps):
        f0_prob, f0_mean, f0_std = main(filename)
        f0_probs.append(f0_prob)
        f0_stds.append(f0_mean)
        f0_means.append(f0_std)

    #outs_f0 = process_map(main, list_gps, cores=2, chunksize=10)

    # print("Organize outputs...")
    # f0_probs = []
    # f0_stds = []
    # f0_means = []
    # for out_f0 in outs_f0:
